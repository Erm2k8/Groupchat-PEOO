# Sistema de troca de mensagens - PEOO - 4º Bimestre

*Uma aplicação de troca de mensagens em grupo utilizando Streamlit para a conclusão disciplina de Programação Estruturada e Orientada a Objetos.*
